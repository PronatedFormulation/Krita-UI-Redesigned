...
class ntToggleVisibleButton(QToolButton):
    def __init__(self, parent = None):
        ...
        # Applied later via pad.updateStyleSheet() so it always matches the active theme
        self.setStyleSheet(variables.nu_toggle_button_style if variables.nu_toggle_button_style else "")
